...
var mailTransport = nodemailer.createTransport('smtps://brittaniFernandez81%40gmail.com:RoboSlam27!@smtp.gmail.com');

// TODO(DEVELOPER): Change the two placeholders below.
// [START initialize]
// Initialize the app with a service account, granting admin privileges
firebase.initializeApp({
  databaseURL: 'https://toga.firebaseio.com',
  serviceAccount: 'toga-c0367676b252.json'
});
// [END initialize]
...
function startWeeklyTopPostEmailer() {
  ...
  schedule.scheduleJob({hour: 19, minute: 13, dayOfWeek: 2}, function () {
